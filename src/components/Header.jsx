  ...
  return (
    <div className='px-6 md:px-0 md:pl-9 xl:mt-6'>
      <header className='flex items-center justify-between pt-6 md:pt-0 xl:justify-normal'>
        ...
        <div className='bg-white z-10 h-[1px] w-[100%] flex-1 translate-x-7'></div>
        <nav className='hidden md:block bg-white/[4%] backdrop-blur-[40px] xl:pl-5 xl:pr-10 xl:flex-1'>
