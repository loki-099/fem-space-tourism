  ...
  return (
    <div className='w-full h-full relative overflow-x-hidden bg-home-mobile bg-center bg-no-repeat bg-cover md:bg-home-tablet xl:bg-home-desktop'>
      <div>
        ...
        <div className='mt-12 md:mt-28 px-6 mx-auto flex flex-col items-center gap-20 md:gap-40'>
          <div className='w-full max-w-[450px] flex flex-col items-center gap-4 md:gap-6'>
            <h5 className='heading-5 uppercase'>So, You want to travel to</h5>
            <h1 className='heading-1 uppercase'>Space</h1>
            <p className='body text-center'>Let's face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we'll give you a truly out of this world experience!</p>
          </div>
