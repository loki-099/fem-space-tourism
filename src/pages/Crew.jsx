...
const Crew = () => {
  ...
  return (
    <div className='relative w-full h-screen overflow-y-auto bg-crew-mobile bg-no-repeat bg-cover md:bg-crew-tablet xl:bg-crew-desktop'>
      <Header/>
      <div className='px-6 md:px-9 xl:px-[136px] xl:pb-14 my-6 md:my-0 flex flex-col items-center md:items-baseline md:pb-0'>
        <h5 className='heading-5 uppercase text-accent'><span className='font-bold opacity-25 mr-3'>02</span>Meet your Crew</h5>
        <div className='mt-8 md:mt-16 w-full md:flex md:flex-col-reverse'>
          {/* SWIPER */}
          <div className='w-full mx-auto max-w-[500px] md:max-w-[900px] h-[225px] md:h-[532px] md:mt-10'>
            <CrewSwiper crews={crews} slide={swiperRef} setCurCrew={setCurCrew}/>
          </div>
          {/* NAME, POSITION, INFO, BUTTON */}
          <div className='mt-8 flex flex-col gap-8 md:gap-10 md:flex-col-reverse md:mt-0'>
            ...
            <div className='flex flex-col items-center'>
              ...
              <p className='mt-4 body text-center pb-8 md:pb-0 md:w-[80%]'>{cur.body}</p>
            </div>
          </div>
        </div>
      </div>
